...
directory is deleted when you empty the cache.
	',
	'c_fabrique_git' => 'It’s so easy!',
	'c_fabrique_git_texte' => 'You will certainly appreciate being producing a plugin managing one or more editorial objects. Good!
		<br /><br />
...
This plugin can however also be used to study the code generated based on the options you select.
	...
	'chaine_titre_page_objets' => 'The @objets@',
	'chaine_titre_page_objets_feminin' => 'The @objets@',
...
you must complete certain information below.',
	...
	'label_afficher_liens_explication' => 'On the view of your object you can list the objects (selected above) that are linked to it.
...
you will then have to overload the list file used (prive/objets/liste/xxx.html) to add an additional criterion `{xxx_liens.id_xxx ?}`.',
	...
	'label_champ_date_publication_ignore' => 'Ignore the publication date field? ',
	'label_champ_date_publication_ignore_case' => 'Do not manage a publication date field, even if a <code>date</code> field is present in the object’s field list. ',
...
Leave blank for not looking into it.',
	...
	'label_saisies_mode' => 'Mode of entries',
	'label_saisies_mode_explication' => 'Entries in forms can be inserted either as tags in the HTML or declared in PHP. ',
