...
define('_ECRAN_SECURITE', '1.6.5'); // 2025-02-14
...
if (
	isset($__request['action'])
	and $__request['action'] == 'api_transmettre'
	and isset($__request['arg'])
	and strpos((string)$__request['arg'], '<') !== false
) {
	$ecran_securite_raison = "api_transmettre";
}
